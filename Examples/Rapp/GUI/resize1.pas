...

{
  ===========================================================================
  Project : resize1
  Topic   : colourful redrawing after changing the window size
  Author  : Thomas Rapp 
  Source  : http://thomas-rapp.homepage.t-online.de/examples/resize1.c
  ===========================================================================
...
begin
  ...
  begin
    ...
    begin
      if (redraw) then
      begin
        draw_ellipse(win^.RPort, win^.BorderLeft, win^.BorderTop, win^.GZZWidth, win^.GZZHeight, vp, pen);
        redraw := FALSE;
      end;
