...

{
  ===========================================================================
  Project : example8d
  Topic   : Graphics using datatypes
...
begin
  ...
  [
    ...
    TAG_(MUIA_Application_Base)         , TAG_(PChar('EXAMPLE8D')),
    TAG_(MUIA_Application_Copyright)    , TAG_(PChar('© 1999 by BlaBla Corp.')),
    TAG_(MUIA_Application_Description)  , TAG_(PChar('Example 8d to the MUI tutorial')),
    TAG_(MUIA_Application_Title)        , TAG_(PChar('Example8d')),
    TAG_(MUIA_Application_Version)      , TAG_(PChar('$VER: example8d 1.0 (20.10.1999) BLABLA PRODUCT')),
    TAG_(MUIA_Application_Window)       , TAG_(SetAndGet(Win, MUI_NewObject (MUIC_Window,
    [
      TAG_(MUIA_Window_Title)           , TAG_(PChar('Example 8d')),
      ...
      [
        ...
        [
          ...
          [
            ...
            TAG_(MUIA_FixWidth)         , 140,
            TAG_(MUIA_FixHeight)        , 89,
            TAG_(MUIA_Image_FreeVert)   , TAG_(TRUE),
            TAG_(MUIA_Image_FreeHoriz)  , TAG_(TRUE),
            TAG_(MUIA_InnerTop)         , 0,
            TAG_(MUIA_InnerBottom)      , 0,
            TAG_(MUIA_InnerLeft)        , 0,
            TAG_(MUIA_InnerRight)       , 0,
            TAG_(MUIA_Image_Spec)       , TAG_(PChar('5:PROGDIR:blablaproduct.png')),
            TAG_END
          ])),
          TAG_(MUIA_Group_Child)        , TAG_(MUI_NewObject (MUIC_Rectangle,
          [
