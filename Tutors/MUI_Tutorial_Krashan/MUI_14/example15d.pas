...

{
  ===========================================================================
  Project : example15d
  Topic   : APPM_RemSubWindow message structure to close multiple subwindows
...
begin
  ...
  [
    ...
    [
      TAG_(MUIA_Window_Title)       , TAG_(PChar('Example 15d')),
...
begin
  ...
  begin
    ...
    [
      ...
      2, TAG_(APPM_RemSubWindow), TAG_(subwin)
    ]);
...
begin
  ...
  [
    ...
    TAG_(MUIA_Application_Base)         , TAG_(PChar('EXAMPLE15D')),
    TAG_(MUIA_Application_Copyright)    , TAG_(PChar('© 2000 by Grzegorz Kraszewski')),
    TAG_(MUIA_Application_Description)  , TAG_(PChar('Example 15d to the MUI tutorial')),
    TAG_(MUIA_Application_Title)        , TAG_(PChar('Example15d')),
    TAG_(MUIA_Application_Version)      , TAG_(PChar('$VER: example15d 1.0 (25.11.2000)')),
    TAG_END
  ]);
