...

{
  ===========================================================================
  Project : example15a
  Topic   : Show complication when closing a subwindow
...
begin
  ...
  [
    ...
    [
      TAG_(MUIA_Window_Title)       , TAG_(PChar('Example 15a')),
...
begin
  ...
  [
    ...
    TAG_(MUIA_Application_Base)         , TAG_(PChar('EXAMPLE15A')),
    TAG_(MUIA_Application_Copyright)    , TAG_(PChar('© 2000 by Grzegorz Kraszewski')),
    TAG_(MUIA_Application_Description)  , TAG_(PChar('Example 15a to the MUI tutorial')),
    TAG_(MUIA_Application_Title)        , TAG_(PChar('Example15a')),
    TAG_(MUIA_Application_Version)      , TAG_(PChar('$VER: example15a 1.0 (25.11.2000)')),
    TAG_END
  ]);
