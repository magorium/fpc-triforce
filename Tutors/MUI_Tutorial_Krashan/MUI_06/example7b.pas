...
begin
  ...
  [
    ...
    TAG_(MUIA_Application_Base)         , TAG_(PChar('EXAMPLE7B')),
    TAG_(MUIA_Application_Copyright)    , TAG_(PChar('© 1999 by BlaBla Corp.')),
    TAG_(MUIA_Application_Description)  , TAG_(PChar('Example 7b to the MUI tutorial')),
    TAG_(MUIA_Application_Title)        , TAG_(PChar('Example7b')),
    TAG_(MUIA_Application_Version)      , TAG_(PChar('$VER: example7b 1.0 (2.9.1999) BLABLA PRODUCT')),
    TAG_(MUIA_Application_Window)       , TAG_(SetAndGet(Win, MUI_NewObject (MUIC_Window,
    [
      TAG_(MUIA_Window_Title)           , TAG_(PChar('Example 7b')),
      ...
      [
        ...
        [
          ...
          TAG_(MUIA_Group_Child)        , TAG_(MUI_NewObject (MUIC_Text,
          [
            TAG_(MUIA_Text_Contents)    , TAG_(PChar(Esc_R + 'without phantom frame')),
            TAG_(MUIA_Text_SetMax)      , TAG_(TRUE),
            TAG_END
          ])),
          TAG_END
        ])),
        TAG_(MUIA_Group_Child)          , TAG_(MUI_NewObject (MUIC_Group,       //* a group of strings */
        [
