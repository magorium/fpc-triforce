...
begin
  ...
  [
    ...
    TAG_(MUIA_Application_Base)         , TAG_(PChar('EXAMPLE7D')),
    TAG_(MUIA_Application_Copyright)    , TAG_(PChar('© 1999 by BlaBla Corp.')),
    TAG_(MUIA_Application_Description)  , TAG_(PChar('Example 7d to the MUI tutorial')),
    TAG_(MUIA_Application_Title)        , TAG_(PChar('Example7d')),
    TAG_(MUIA_Application_Version)      , TAG_(PChar('$VER: example7d 1.0 (2.9.1999) BLABLA PRODUCT')),
    TAG_(MUIA_Application_Window)       , TAG_(SetAndGet(Win, MUI_NewObject (MUIC_Window,
    [
      TAG_(MUIA_Window_Title)           , TAG_(PChar('Example 7d')),
      ...
      [
        ...
        [
          ...
          [
            TAG_(MUIA_Text_Contents)    , TAG_(PChar(Esc_R + 'Labels group')),
        ...
        TAG_(MUIA_Group_Child)          , TAG_(MUI_NewObject (MUIC_Text,
        [
          TAG_(MUIA_Text_Contents)      , TAG_(PChar(Esc_R + 'array')),
          TAG_(MUIA_Frame)              , TAG_(MUIV_Frame_String),
          TAG_(MUIA_FramePhantomHoriz)  , TAG_(TRUE),
          TAG_(MUIA_HorizWeight)        , 0,
          TAG_END
